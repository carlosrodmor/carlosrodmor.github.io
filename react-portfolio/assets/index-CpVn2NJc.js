...
var Hr = {
  ...
  us = tt(Wg),
  Vg = oe({}, Hr, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  Hg = tt(Vg),
  Yg = oe({}, Hr, {
...
var Jg = oe({}, ro, {
  ...
  ry = tt(ny),
  iy = oe({}, Hr, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  oy = tt(iy),
  ay = oe({}, Xa, {
    deltaX: function (e) {
  ...
  hi = null
Ht && 'documentMode' in document && (hi = document.documentMode)
var uy = Ht && 'TextEvent' in window && !hi,
  gh = Ht && (!Ec || (hi && 8 < hi && 11 >= hi)),
  dd = ' ',
  pd = !1
function yh(e, t) {
  switch (e) {
    ...
    case 5:
      ...
      if (r & 4 && ((i = e.stateNode), i != null)) {
        ...
        if (((e.updateQueue = null), s !== null))
          try {
            l === 'input' && o.type === 'radio' && o.name != null && Hm(i, o), Js(l, a)
            var u = Js(l, o)
...
function E0(e, t) {
  ...
  if (t !== 0) {
    if ((t === 2 && ((i = iu(e)), i !== 0 && ((r = i), (t = Au(e, i)))), t === 1))
      throw ((n = Wi), Bn(e, 0), sn(e, r), He(e, ce()), n)
    if (t === 6) sn(e, r)
    else {
      if (
  ...
  return He(e, ce()), e.callbackNode === n ? E0.bind(null, e) : null
}
function Au(e, t) {
  var n = xi
  return (
...
function sn(e, t) {
  for (
    t &= ~Hc, t &= ~il, e.suspendedLanes |= t, e.pingedLanes &= ~t, e = e.expirationTimes;
    0 < t;
...
function qd(e) {
  ...
  if (n === 1) throw ((n = Wi), Bn(e, 0), sn(e, t), He(e, ce()), n)
...
function O0(e) {
  ...
  ;(e.memoizedProps = e.pendingProps), t === null ? T0(e) : (ve = t), (Vc.current = null)
}
function T0(e) {
  var t = e
  do {
...
function Mn(e, t, n) {
  var r = V,
    i = ct.transition
  try {
    ;(ct.transition = null), (V = 1), e2(e, t, n, r)
  } finally {
    ;(ct.transition = i), (V = r)
  }
  return null
...
function Nr() {
  if (fn !== null) {
    var e = uh(Ma),
      ...
      n = V
    try {
      if (((ct.transition = null), (V = 16 > e ? 16 : e), fn === null)) var r = !1
      else {
...
function N0(e, t) {
  ...
  var n = ze()
  ;(e = Kt(e, t)), e !== null && (no(e, t, n), He(e, n))
}
function n2(e) {
  var t = e.memoizedState,
    n = 0
...
R0 = function (e, t, n) {
  if (e !== null)
    if (e.memoizedProps !== t.pendingProps || We.current) Be = !0
      ...
      if (!(e.lanes & n) && !(t.flags & 128)) return (Be = !1), Vy(e, t, n)
      Be = !!(e.flags & 131072)
    }
...
function aa(e, t, n, r, i, o) {
  ...
  if (((r = e), typeof e == 'function')) Xc(e) && (a = 1)
    ...
    e: switch (e) {
      ...
      case Vs:
        return (e = ut(13, n, t, i)), (e.elementType = Vs), (e.lanes = o), e
      case Hs:
        return (e = ut(19, n, t, i)), (e.elementType = Hs), (e.lanes = o), e
      case Bm:
        return ol(n, i, o, t)
      default:
  ...
  switch (e.tag) {
    case 3:
      ...
      if (t.current.memoizedState.isDehydrated) {
        ...
        n !== 0 && (wc(t, n | 1), He(t, ce()), !(D & 6) && ((Ur = ce() + 500), Nn()))
      }
      break
    case 13:
      Qn(function () {
                  ...
                  children: S.jsxs(Io.Button, {
                    ...
                    children: [
                      ...
                      e
                        ...
                        : S.jsx(H2, { className: 'block h-6 w-6', 'aria-hidden': 'true' })
                    ]
                  })
                }),
                S.jsxs('div', {
...
function wp(e, t, n, r, i, o, a, l, s, u, c) {
  for (var f = i - 1, p = i === 0 ? o : [''], y = pf(p), g = 0, v = 0, k = 0; g < r; ++g)
    for (var m = 0, d = Hi(e, f + 1, (f = qw((v = a[g])))), h = e; m < y; ++m)
      (h = c1(v > 0 ? p[m] + ' ' + d : B(d, /&\f/g, p[m]))) && (s[k++] = h)
  return vl(e, t, n, i === 0 ? ff : l, s, u, c)
}
function ux(e, t, n) {
  return vl(e, t, n, s1, ml(nx()), Hi(e, 2, -2), 0)
}
function xp(e, t, n, r) {
  return vl(e, t, n, df, Hi(e, 0, r), Hi(e, r + 1, -1), r)
}
function Ar(e, t) {
...
function Yx(e) {
  const { styles: t, defaultTheme: n = {} } = e,
    r = typeof t == 'function' ? i => t(Hx(i) ? n : i) : t
...
const A3 = fe({ prop: 'gridColumn' }),
  ...
  D3 = fe({ prop: 'gridArea' })
Dl(Bl, Wl, Vl, A3, $3, j3, M3, I3, L3, z3, F3, D3)
function $r(e, t) {
  return t === 'grey' ? t : e
}
...
const V3 = fe({ prop: 'width', transform: Qe }),
  bf = e => {
...
const H3 = fe({ prop: 'minWidth', transform: Qe }),
...
const f4 = e => c4(e) && e !== 'classes',
  Lt = o5({ themeId: Y1, defaultTheme: H1, rootShouldForwardProp: f4 })
function K1(e, t) {
  const n = $({}, t)
  return (
...
function An({ props: e, name: t }) {
  return g4({ props: e, name: t, defaultTheme: H1, themeId: Y1 })
}
const Up = e => {
  let t
  return (
...
function O4() {
  this.visibilityState === 'hidden' && Vu && (Kl = !0)
}
function T4(e) {
...
const W4 = ['className', 'component'],
  ...
  Y4 = w.forwardRef(function (t, n) {
    const r = An({ props: t, name: 'MuiCardContent' }),
      ...
      l = $({}, r, { component: o }),
      s = V4(l)
    return S.jsx(H4, $({ as: o, className: Ce(s.root, i), ownerState: l, ref: n }, a))
  })
function K4(e) {
...
const bk = $n('MuiButtonBase', ['root', 'disabled', 'focusVisible']),
  ...
  _k = w.forwardRef(function (t, n) {
    ...
    function Ft(L, Hf, Fv = f) {
      return Fo(Yf => (Hf && Hf(Yf), !Fv && _.current && _.current[L](Yf), !0))
    }
    const Ev = Ft('start', E),
      Pv = Ft('stop', k),
      _v = Ft('stop', m),
...
function Nf(e, t) {
  return Bk(e) || Vk(e, t) || G1(e, t) || Yk()
}
function mo(e) {
  return Uk(e) || Wk(e) || G1(e) || Hk()
}
function Uk(e) {
...
var Xi = ho(
  ...
  eS = ho(
    ((Ho = {}),
    we(Ho, q, { 900: 'fas', 400: 'far', normal: 'far', 300: 'fal', 100: 'fat' }),
    we(Ho, ue, { 900: 'fass', 400: 'fasr', 300: 'fasl', 100: 'fast' }),
    Ho)
  ),
...
var St = qt[Xt],
  ...
  Ha = !1
en &&
  ((Ha = (J.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/).test(
    J.readyState
  )),
  Ha || J.addEventListener('DOMContentLoaded', hS))
function vS(e) {
  en && (Ha ? setTimeout(e, 0) : lv.push(e))
}
function vo(e) {
  var t = e.tag,
    n = e.attributes,
...
const Ib = () => {
  const e = [$b, Rb, jb, Ab, Mb, S.jsx(Nb, {})],
    t = r =>
      r.iconName
        ...
        S.jsxs('div', {
          ...
          children: [
            ...
            S.jsx('a', {
              ...
              className: 'text-gray-300 hover:text-white mx-10',
              children: S.jsx(Lb, { size: 72, style: { cursor: 'pointer' } })
            })
          ]
        })
      ]
...
const Fb = () =>
    S.jsxs(Aw, {
      children: [
        S.jsx(Lu, { path: '/', element: S.jsx(zb, {}) }),
...
function Ub() {
  return S.jsx(Mw, {
    children: S.jsxs('div', {
      className: 'App',
      children: [S.jsx(X2, {}), S.jsx(Fb, {}), S.jsx(Db, {})]
    })
  })
}
Us.createRoot(document.getElementById('root')).render(
  S.jsx(Q.StrictMode, { children: S.jsx(Ub, {}) })
)
