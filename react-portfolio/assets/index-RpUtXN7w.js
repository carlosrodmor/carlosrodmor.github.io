...
const Md = [
  ...
  {
    name: 'CV',
    href: 'https://drive.google.com/file/d/1EatHy3vMx8SyO1HnvySSV20JsRbqg_wm/view?usp=sharing',
    current: !1,
    target: '_blank'
  }
]
      ...
      S.jsxs('div', {
        ...
        children: [
          S.jsx(ps, {
            ...
            description:
              'This was my first project manipulating the DOM (⚠️ IMPORTANT: IF YOU LOSE, YOU MUST PRESS SPACE AND THEN ENTER.)',
            imageUrl: j4,
